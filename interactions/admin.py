...
class UserArticleAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ("Relationship", {"fields": ("user", "article")}),
        (
            "Interaction Status",
            {
                "fields": (
...
class NoteAdmin(admin.ModelAdmin):
    ...
    list_filter = ["has_follow_up", "follow_up_done", "created_at"]
    ...
    fieldsets = [
        ...
        (
            "Follow-up Tracking",
            {"fields": ("has_follow_up", "follow_up_done", "follow_up_date")},
        ),
...
class ArticleReferenceAdmin(admin.ModelAdmin):
    ...
    list_display = ["source_note_info", "referenced_article_truncated", "created_at"]

    search_fields = ["source_note__content", "referenced_article__title"]
...
class ReadingHistoryAdmin(admin.ModelAdmin):
    ...
    list_display = ["user", "article_truncated", "read_at", "time_spent_formatted"]
